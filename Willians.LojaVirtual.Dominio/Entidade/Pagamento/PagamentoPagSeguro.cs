...
namespace Willians.LojaVirtual.Dominio.Entidade.Pagamento
{
    [XmlRoot("checkout")]
    public class PagamentoPagSeguro
    {
        ...
        #region Transferência valores do Pedido para PagSeguro
        ...
        #endregion Transferência valores do Pedido para PagSeguro
